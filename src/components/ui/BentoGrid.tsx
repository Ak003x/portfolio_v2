...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('aakash.velu.003@gmail.com');
  ...
  return (
    ...
    >
      <div className={`${id === 6} && 'flex justify-center h-full' `}>
        ...
        >
          <div className="font-sans text-sm font-extralight text-[#c1c2d3]5 md:text-xs lg:text-base z-10">
            {description}
          </div>
          ...
          {id === 2 && <GlobeDemo />}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-4 w-fit absolute -right-3 lg:right-3 top-5 ">
              ...
              <div className="flex flex-col gap-3 lg:gap-4">
                {['React.js', 'Next.js', 'Software Testing'].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-sm opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e] "
                  >
